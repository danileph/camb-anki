...
const Input: FC<IInputProps> & IInputComposition = ({
  inputClassName,
  sizing = "large",
  icon,
  placeholder = "",
  ...
  return (
    <div css={[styles.base, styles[sizing], css]} className={className}>
      {icon != null && icon}
      {placeholder !== "" && (
        <Label isLabel={isFocused || value !== ""} placeholderOnly={!withLabel}>
          {placeholder}
        </Label>
      )}
      <input
